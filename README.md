...
docker exec -it ollama ollama pull gemma:2b
    ...
    Model Customization: Feel free to swap gemma:2b for other lightweight models:
        ...
        docker exec -it ollama ollama pull llama3:8b (Excellent balance of power and size)

        docker exec -it ollama ollama pull phi3:mini (Microsoft's highly efficient small model)
